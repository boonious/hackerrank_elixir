...
"
    ...
    test "super_queen - Super queens on a chess board, identify placement candidates for further evaluation" do
      x = [[{0,1},{9,8}],[{0,2},{9,7}],[{0,3},{9,6}],[{0,4},{9,5}],[{0,5},{9,4}],[{0,6},{9,3}],[{0,7},{9,2}],[{0,8},{9,1}],[{1,0},{8,9}],[{1,2},{8,7}],[{1,3},{8,6}],[{1,4},{8,5}],[{1,5},{8,4}],[{1,6},{8,3}],[{1,7},{8,2}],[{1,9},{8,0}],[{2,0},{7,9}],[{2,1},{7,8}],[{2,3},{7,6}],[{2,4},{7,5}],[{2,5},{7,4}],[{2,6},{7,3}],[{2,8},{7,1}],[{2,9},{7,0}],[{3,0},{6,9}],[{3,1},{6,8}],[{3,2},{6,7}],[{3,4},{6,5}],[{3,5},{6,4}],[{3,7},{6,2}],[{3,8},{6,1}],[{3,9},{6,0}],[{4,0},{5,9}],[{4,1},{5,8}],[{4,2},{5,7}],[{4,3},{5,6}],[{4,6},{5,3}],[{4,7},{5,2}],[{4,8},{5,1}],[{4,9},{5,0}]]
      assert super_queen(10) == x
    end

    test "super_queen_power_zone - Super queens on a chess board, find zone of power in a n-size grid for a queen at i,j position" do
      x = [{{0,0},1},{{0,1},0},{{0,2},0},{{0,3},1},{{0,4},0},{{0,5},0},{{0,6},1},{{1,0},0},{{1,1},1},{{1,2},1},{{1,3},1},{{1,4},1},{{1,5},1},{{1,6},0},{{2,0},0},{{2,1},1},{{2,2},1},{{2,3},1},{{2,4},1},{{2,5},1},{{2,6},0},{{3,0},1},{{3,1},1},{{3,2},1},{{3,3},1},{{3,4},1},{{3,5},1},{{3,6},1},{{4,0},0},{{4,1},1},{{4,2},1},{{4,3},1},{{4,4},1},{{4,5},1},{{4,6},0},{{5,0},0},{{5,1},1},{{5,2},1},{{5,3},1},{{5,4},1},{{5,5},1},{{5,6},0},{{6,0},1},{{6,1},0},{{6,2},0},{{6,3},1},{{6,4},0},{{6,5},0},{{6,6},1}]
      assert super_queen_power_zone({3,3}, 7) == x

      x = [{{0,0},1},{{0,1},1},{{0,2},1},{{0,3},1},{{0,4},1},{{0,5},1},{{0,6},1},{{1,0},1},{{1,1},1},{{1,2},1},{{1,3},0},{{1,4},0},{{1,5},0},{{1,6},0},{{2,0},1},{{2,1},1},{{2,2},1},{{2,3},0},{{2,4},0},{{2,5},0},{{2,6},0},{{3,0},1},{{3,1},0},{{3,2},0},{{3,3},1},{{3,4},0},{{3,5},0},{{3,6},0},{{4,0},1},{{4,1},0},{{4,2},0},{{4,3},0},{{4,4},1},{{4,5},0},{{4,6},0},{{5,0},1},{{5,1},0},{{5,2},0},{{5,3},0},{{5,4},0},{{5,5},1},{{5,6},0},{{6,0},1},{{6,1},0},{{6,2},0},{{6,3},0},{{6,4},0},{{6,5},0},{{6,6},1}]
      assert super_queen_power_zone({0,0}, 7) == x
    end
